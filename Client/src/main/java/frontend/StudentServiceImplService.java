 ...
 * 
 */
@WebServiceClient(name = "StudentServiceImplService", targetNamespace = "http://frontend/", wsdlLocation = "http://localhost:8800/StudentService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTSERVICEIMPLSERVICE_QNAME = new QName("http://frontend/", "StudentServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8800/StudentService?wsdl");
    ...
    public StudentService getStudentServicePort() {
        return super.getPort(new QName("http://frontend/", "StudentServicePort"), StudentService.class);
    }
    ...
    public StudentService getStudentServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://frontend/", "StudentServicePort"), StudentService.class, features);
    }
