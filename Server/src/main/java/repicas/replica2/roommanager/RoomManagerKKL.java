...
public class RoomManagerKKL implements RoomManager {
    ...
    public static RoomManagerKKL roomManager;

    private RoomManagerKKL() {
    }

    public static RoomManagerKKL getInstance() {
        if (roomManager == null) {
            roomManager = new RoomManagerKKL();
        }
        return roomManager;
    }
