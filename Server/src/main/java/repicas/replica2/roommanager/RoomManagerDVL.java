...
import repicas.replica2.model.BookingRecord;
import repicas.replica2.utils.Network;
import repicas.replica2.Setting;
...
public class RoomManagerDVL implements RoomManager {
    ...
    public static RoomManagerDVL roomManager;

    private RoomManagerDVL() {
    }

    public static RoomManagerDVL getInstance() {
        if (roomManager == null) {
            roomManager = new RoomManagerDVL();
        }
        return roomManager;
    }
