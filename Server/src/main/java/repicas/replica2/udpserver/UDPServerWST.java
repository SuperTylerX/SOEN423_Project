package repicas.replica2.udpserver;
            ...
            while (true) {
                ...
                switch (method) {
                    case "getAvailableTimeSlot":
                        ...
                        result = String.valueOf(RoomManagerWST.getInstance().getAvailableTimeSlot(param));
                        break;
                    case "bookRoomRemote": {
                        ...
                        result = RoomManagerWST.getInstance().addRoomRecord(date, roomNumber, timeSlot, studentID);
                        break;
                    }
                    case "removeBookingRemote": {
                        ...
                        String timeSlot = br.readLine();
                        String studentID = br.readLine();
                        result = RoomManagerWST.getInstance().removeRoomRecord(date, roomNumber, timeSlot, studentID);
                        break;
                    }
                }
